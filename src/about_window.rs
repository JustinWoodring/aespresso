...
use gtk::{Application, ApplicationWindow, Button, Box, Frame, Label, ScrolledWindow, ButtonBox, Adjustment, LinkButton};
...
pub fn new(app : &Application, app_data : &AppData) -> ApplicationWindow{
	...
	let label_repo_link = LinkButton::new_with_label(&app_data.repo.0,Some(&app_data.repo.1));
	...
	let close_about = Button::new_with_label("Close");
